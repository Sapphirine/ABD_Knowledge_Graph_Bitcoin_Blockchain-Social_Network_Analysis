...
#   users_out: the string path where to write the 'user' groupings
#   rows: the main data matrix
#   return the dictionary mapping pubkeys to grouping numbers

#   This script writes the groupings of pubkeys given their use as shared inputs to a transaction it returns a dictionary where d[key] := "the line number to find the pubkey in the outputted file."
#
